...
public class OSRMRouteClientTest {
	...
	public void parseResultTest() throws JsonProcessingException, IOException {
		...
		RouteResult result = OSRMClient.parseRouteResult(json);
		
		Assert.assertEquals(632.9, result.distanceMeters, 0.001);
		Assert.assertEquals(96.9, result.durationSeconds, 0.001);
		Assert.assertEquals(new LonLat(16.378604, 48.206973), result.vertices[6]);
	}
